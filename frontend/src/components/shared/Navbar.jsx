...
function Navbar() {
  ...
  return (
    <div className="h-21 bg-white mx-auto  border shadow-xs rounded-b-2xs">
            ...
            <Popover>
              ...
              <PopoverContent className="w-80">
                <div className="flex gap-4 space-y-2">
                  ...
                  <div>
                    <h4 className="font-medium pt-1">{user?.username}</h4>
                ...
                <div className="flex flex-col mt-4 gap-2">
                  {user && user.role === "student" ? (
                    <div className="flex w-fit gap-2 items-center cursor-pointer">
                      <User2 />
                      <Button variant="link" className="bg-white h-7">
